...
- [database](https://github.com/phuse-org/sendigR/blob/main/tests/data/send_no_duplicates.db)

Download the database in local directory and update the dbPath.
### Demo 
Demo of the app can be found here 
- [Shiny App Demo](https://phuse-org.shinyapps.io/sendigR/)
## Sidebar Menu
...
Plot show mean body weight over age days. 

################################################################################
## Test cases for the function getStudiesSTSTDTC with PostgreSQL database
##
##
## Expected data are located in: /tests/data/021_expected_getStudiesSTSTDTC.xls
################################################################################
...
studyListIn <- data.table::data.table(STUDYID = c('CJ16050',
                                                  'Study ID',
                                                  'GLP003',
                                                  'Nimort-01',
                                                  'PDS2014',
...
studyListInMsg <- data.table::data.table(STUDYID = c('CJ16050',
                                                     'Study ID',
                                                     'GLP003',
                                                     'Nimort-01',
                                                     'PDS2014',
                                         ...
                                         SDESIGN = c('PARALLEL',
                                                     ...
                                                     'PARALLEL',
                                                     'PARALLEL'),
                                         NOT_VALID_MSG = c('SDESIGN: A message',
                                                           NA,
                                                           NA,
                                                           NA,
                                                           NA,
                                                           'SDESIGN: Another message'))

studyListInUncertain <- data.table::data.table(STUDYID = c('CJ16050',
                                                           'Study ID',
                                                           'GLP003',
                                                           'Nimort-01',
                                                           'PDS2014',
                                               ...
                                               SDESIGN = c('PARALLEL',
                                                           ...
                                                           'PARALLEL',
                                                           'PARALLEL'),
                                               UNCERTAIN_MSG = c('SDESIGN: A message',
                                                                 NA,
                                                                 NA,
                                                                 NA,
                                                                 NA,
...
studyListInMsgUncertain <- data.table::data.table(STUDYID = c('CJ16050',
                                                              'Study ID',
                                                              'GLP003',
                                                              'Nimort-01',
                                                              'PDS2014',
...
# Study Lists defined in first section
